    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('f_createdate', models.DateTimeField(blank=True, default=datetime.datetime(2022, 5, 20, 10, 44, 33, 220555))),
                ('f_updatedate', models.DateTimeField(blank=True, default=datetime.datetime(2022, 5, 20, 10, 44, 33, 220555))),
