...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            model_name='fboard',
            name='f_createdate',
            field=models.DateTimeField(blank=True, default=datetime.datetime(2022, 5, 27, 17, 17, 42, 747489)),
        ),
        migrations.AlterField(
            model_name='fboard',
            name='f_updatedate',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('c_date', models.DateTimeField(blank=True, default=datetime.datetime(2022, 5, 27, 17, 17, 42, 747489))),
